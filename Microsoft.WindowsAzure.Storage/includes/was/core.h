...
namespace azure { namespace storage {
    ...
    public:
        ...
        /// <summary>
        /// Gets the inner exception object that causes current <see cref="storage_exception"/>.
        /// </summary>
        /// <returns>An exception_ptr object pointing to the inner exception object that causes current
